 ...
 */
            ...
            /**
            *  GETDOCLISTSBYDATE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GETDOCLISTSBYDATE
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GETDOCLISTSBYDATE",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GETDOCLISTSBYDATE",
    ...
    public static class Factory{
        ...
        */
        public static GETDOCLISTSBYDATE parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GETDOCLISTSBYDATE object =
                new GETDOCLISTSBYDATE();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GETDOCLISTSBYDATE".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GETDOCLISTSBYDATE)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
